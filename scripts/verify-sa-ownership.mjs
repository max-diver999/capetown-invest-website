#!/usr/bin/env node
/**
 * Verify SA ownership for capetown-invest.com via Site Verification API.
 *
 * Usage:
...
const SITE_URL = 'https://capetown-invest.com/';
...
async function getToken() {
  ...
  console.log(`  2. Verify file is live: curl https://capetown-invest.com/${token}`);
