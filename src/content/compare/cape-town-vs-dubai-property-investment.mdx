...
This comparison sits alongside the deeper Cape Town material. For the practical foreign-buyer process, from FICA to exchange control and repatriation, read [Buying Cape Town Property as a Foreigner](/guides/buy-cape-town-property-foreigner/). For the full Cape Town thesis, market data, and area tiers, see the [Cape Town Property Investment Guide](/guides/cape-town-property-investment-guide/). For the income math by node, the [Cape Town Rental Yield Guide](/guides/cape-town-rental-yield-guide/) walks through modeled gross and net.
