...
readingTime: 14
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356235/more-group/capetown/compare/cape-town-vs-portugal-property-investment.jpg"
...
Two Portuguese incentives used to do the heavy lifting in this comparison, and both are now gone for the typical buyer. First, the Golden Visa. Property stopped qualifying for it in October 2023, so a Lisbon or Algarve apartment today carries the full IMT of up to roughly 7.5 to 8% plus the 0.8% stamp duty with no residency attached to that cost at all.
...
Yield is where Cape Town wins on paper, and where the comparison needs the most care. Cape Town income nodes model roughly 6% to 9% gross against a Portuguese benchmark nearer 4% to 6%, with Lisbon around 4% to 5% and the Algarve around 5% to 6% and heavily seasonal. Sea Point at a modeled 9.7% gross and 7.5% net is the strong case rather than the average one. The gap is real, but it is a rand gap: the income arrives in a currency that has trended weaker, while Portuguese rent arrives in the currency an EU buyer already spends. A 7.5% net in rand and a 5% net in euro only become comparable once you commit to an assumption about the exchange rate over your holding period. Model both at a flat rate and at a steady annual rand slide before you choose.
...
Put a number on the risk before you choose. Hold a Cape Town asset for 10 years with the rand losing 3% a year against the euro and a modeled 7.5% net rand yield lands nearer 4.5% in euro terms, which is roughly the Portuguese range you started from. Hold the same asset through a rand recovery instead and it beats anything Lisbon offers on both income and capital. Non-residents also face a 50% loan-to-value ceiling on South African bonds, so half the purchase price crosses the exchange rate on day one whatever you assume afterwards. Portugal asks a euro buyer for no such conversion.

---

## Residency: not automatic in either market

Neither market hands you residency in exchange for a property purchase, which is the most common misconception in this comparison. Portugal's property-linked Golden Visa closed in October 2023, and the fund-based route that survives is a securities decision rather than a real estate one. South Africa has never connected ownership to a permit, so transfer duty and Portugal's 0.8% stamp duty are both simply costs of owning, not steps toward a passport. Budget for the ordinary visa categories in either country.
...
Insider tip: the two Portuguese incentives that used to decide this comparison are both gone, so rebuild the case on cash flow rather than status. Cape Town Invest models coastal Cape Town near 6% to 9% gross against Portuguese benchmarks around 4% to 6% across Lisbon and the Algarve, with the Western Cape index up about 179.6% from 2010 to September 2025. Portugal has closed the real estate Golden Visa route and shut the NHR tax regime to most new applicants, while IMT and annual AIMI still apply. What remains is a straight currency question: the rand cuts your entry price and adds volatility at exit, the euro costs more up front and removes that risk. Buy Cape Town for yield and entry economics, Portugal for stable euro income, and stop pricing either on a residency benefit.
