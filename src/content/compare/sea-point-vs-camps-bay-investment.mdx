...
readingTime: 14
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356250/more-group/capetown/compare/sea-point-vs-camps-bay-investment.jpg"
...
## What risks should you plan for with Sea Point vs Camps Bay Investment?

Both suburbs carry risks that a yield table alone will not show. Treat these as deal-shaping items, not footnotes. The gap between Sea Point's modeled 7.5% net and Camps Bay's 4.4% is roughly three percentage points, and any item below can move a single year's return by more than that, whether through a special levy, a regulatory change to short letting, or a summer that underdelivers against a 64% to 75% occupancy assumption.
...
Insider tip: read the body corporate conduct rules before you read the levy schedule. A Sea Point block can be priced perfectly and still ban short letting outright, and rules get tightened as often as they get relaxed. Changing a scheme's own management rules under the Sectional Titles Schemes Management Act takes a 75% special resolution, so ask what has been tabled at the last two annual general meetings rather than reading only the rules in force today.
...
## Income Engine vs Trophy Beachfront

Sea Point and Camps Bay answer two different questions, and the numbers make the split obvious. Sea Point models about 9.7% gross and 7.5% net on a one-bedroom, with short-let listings up roughly 33% and bookings up 50%, so the return arrives as monthly cash from a deep, year-round tenant pool. Camps Bay models about 6.8% gross and 4.4% net, with 29 prime sales in 2025 evidencing the exit liquidity that justifies the compressed income. Neither is the better asset in the abstract. A buyer whose hurdle rate is set in cash flow terms takes Sea Point and accepts higher density and uneven building stock. A buyer storing wealth in a globally recognised beachfront address takes Camps Bay and accepts that the rent will not carry the holding costs. Decide which of those two sentences describes your capital before you open a single listing.
