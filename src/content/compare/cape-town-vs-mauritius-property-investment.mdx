...
| Duty on a mid-market home | 3.58% of price on R3 million, R107,356 | 5% of price, whatever the scheme price is |
...
| Lowest cost of entry | Cape Town | Nil duty to R1,210,000, R107,356 on R3 million |
...
<FaqBlock items={[
  ...
  { question: "Which is cheaper to buy into?", answer: "Cape Town, on both the ticket and the tax. South African transfer duty is a sliding national scale that pays nothing on the first R1,210,000 and lands at 3.58% of price on a R3 million home, with no surcharge for foreigners. Mauritius charges non-citizens 5% registration duty on a scheme acquisition, and the scheme itself sets a floor well above the Cape Town median." },
