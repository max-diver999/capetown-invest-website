...
Both suburbs sit inside the City of Cape Town, so the same rate in the rand applies to each, and the difference lands on the rates-free portion at the R8 million line: the [Constantia page](/areas/constantia-property-investment/) works that through, and the [Somerset West page](/areas/somerset-west-property-investment/) covers the Helderberg side.
