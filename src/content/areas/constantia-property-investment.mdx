...
As an amenity they support value: direct access to a walking network is genuinely scarce in a metro suburb and buyers pay for it. As a boundary condition they change the security and privacy profile of an erf, because a property adjoining a public corridor has a perimeter that behaves differently from one surrounded by neighbours. Neither effect is universally positive or negative, and both are specific to the erf rather than to the suburb. Cape Town Invest treats the greenbelt boundary as a due diligence item rather than a marketing feature for that reason: two adjoining properties can experience the same corridor completely differently depending on fencing, planting and how the neighbours use it. Establish which corridors touch the boundary, how that boundary is fenced and lit, and what the neighbours have done about it, because the answer varies street by street and rarely appears in a listing.
