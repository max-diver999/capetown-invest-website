...
Resale pricing on the Ridge Road strip behaves differently from the bungalow blocks below it, and [The Ridge](/projects/the-ridge-clifton/) is the reference scheme for that end of the suburb.
