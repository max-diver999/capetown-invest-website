---
title: "Green Point Property Investment 2026: 8% Gross, 6% Net"
description: "Green Point models 8% gross and 6% net, a walk from the V&A Waterfront. Where it beats Camps Bay on income, where Sea Point wins, and what STR rules allow."
pubDate: 2026-06-17
...
readingTime: 12
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356175/more-group/capetown/areas/green-point-property-investment.jpg"
...
## How should you underwrite Green Point?
...
## What do the 2025 to 2026 numbers say about Green Point?

Green Point models around 8.0% gross and 6.0% net on a one or two-bedroom apartment, against Sea Point's 7.5% net and Camps Bay's 4.4% net on the same strip. Short-term rental bookings across the Atlantic Seaboard rose about 50% in the recent cycle and peak-season occupancy sits near 75%. The table below frames the suburb's income and demand profile against the wider strip.
...
| Sea Point net yield (modelled) | ~7.5% | The strip's income benchmark |
| Camps Bay net yield (modelled) | ~4.4% | The strip's prestige floor |
...
## Why is Green Point between Sea Point and Camps Bay?

First, the price-to-rent ratio. Green Point apartments cost less per unit than comparable stock in Camps Bay or Clifton while achieving rents that track the strip, so the arithmetic starts from a better base and lands near 6.0% net rather than 4.4%. Rent, not prestige, sets the yield here.

Second, the Waterfront effect. Green Point borders the V&A Waterfront, one of South Africa's most visited destinations, with restaurants, retail, marinas, and offices a short walk or drive away. That adjacency keeps both long-let professional demand and short-stay visitor demand deep, which protects occupancy across the rental cycle and supports the modeled 6.0% net. Occupancy is the quiet driver of that number: on an 8.0% gross model, every additional month of vacancy costs roughly 0.7 percentage points of gross yield, which is more than most buyers save by negotiating the price down. A Waterfront-edge address that re-lets in two weeks is therefore worth more than a cheaper block that sits empty for six, and the strip-wide 50% rise in short-term bookings against a 33% rise in listings shows the demand side is still running ahead of supply.
...
## What are the pros and cons of investing in Green Point?
...
Green Point is one of the few Atlantic Seaboard suburbs where both strategies stand up on their own, which makes the choice a question of how much operating work you want rather than which one is obviously better.

The long-let case is the modeled 8.0% gross and 6.0% net, earned from a tenant pool of Waterfront and CBD professionals, medical staff, and remote workers who want a walkable base without Sea Point's density. Leases run twelve months, turnover is low, and a managing agent can run the asset with little owner involvement. That is the version most non-resident owners should model first.

The short-let case rests on the strip-wide signals: listings up about 33%, bookings up about 50%, and peak occupancy near 75%. Bookings growing faster than listings is the constructive part of that picture, but the 75% figure is a peak, not an annual average, and the shoulder months carry the vacancy that averages it down. Cape Town Stadium events and the Waterfront calendar add spikes of demand that a well-run unit can capture, and a poorly run one cannot.

Insider tip: check the block's position relative to the fan walk and the stadium's event nights before you commit. Green Point is quiet for most of the year, but on a concert or match evening the roads between the stadium and the CBD close to through traffic and parking bays fill from late afternoon. Long-let tenants price that in and discount accordingly; short-stay guests who were not warned leave it in the review, which is what actually costs you the next booking.

Three factors decide it in practice. Whether the building's conduct rules permit nightly letting at all, whether you have someone local handling turnovers and guest issues, and whether your unit type suits visitors, since a compact one-bedroom near the park fills differently to a family unit. Where those line up, a hybrid works well: short-let through the summer peak, then a winter lease to bridge the quiet months. Where they do not, take the long-let and stop there. Full operating economics are in the [Airbnb Investment Cape Town Guide](/guides/airbnb-investment-cape-town-guide/).

## How do foreign buyers approach Green Point?
...
The two practical considerations are financing and currency. Expect a local bond of roughly 50 percent as a non-resident, with the remainder funded from your own offshore capital. Record every inward transfer through an authorised dealer, because that paper trail is what allows the proceeds to leave again when you sell.

## What risks should you plan for with Green Point?
...
## Which Green Point property fits your investment goal?
...
<FaqBlock items={[
  {
    question: "Is Green Point a good property investment in 2026?",
    answer: "Green Point is the balanced node of the Atlantic Seaboard, sitting between Sea Point's income engine and Camps Bay's prestige beachfront. A one or two-bedroom apartment models around 8.0% gross and 6.0% net, below Sea Point's 7.5% net but well above Camps Bay's 4.4% net. The draw is V&A Waterfront adjacency, a walkable urban grid with the stadium and Green Point Urban Park on the doorstep, and demand from both long-let professionals and short-stay visitors. Figures are modelled and directional, so rebuild them on net with current rents and the specific block's levies before you offer."
  },
  {
    question: "What rental yield does Green Point offer?",
