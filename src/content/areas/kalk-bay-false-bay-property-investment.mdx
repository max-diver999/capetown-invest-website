...
description: "Kalk Bay property investment: False Bay fishing village, modelled 6.5% gross on cottages, R22k-R45k psqm, UK semigration and mixed long-let demand."
pubDate: 2026-06-26
...
readingTime: 9
segment: "invest"
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356184/more-group/capetown/areas/kalk-bay-false-bay-property-investment.jpg"
heroAlt: "Kalk Bay harbour on the False Bay coast"
...
![Kalk Bay fishing harbor with colorful boats and mountain backdrop](https://upload.wikimedia.org/wikipedia/commons/7/78/Kalk_Bay%2C_Sud%C3%A1frica%2C_2018-07-23%2C_DD_06.jpg)

## Why Kalk Bay attracts property investors in 2026

Kalk Bay attracts investors on income rather than glamour: a village cottage is modelled at roughly 6.5% gross and 5% net at R22,000 to R45,000 per square metre. UK and European semigrators took 28% to 32% of village sales between 2023 and 2025, against an 18% to 22% Western Cape average.

Three pillars carry the case:

- Authentic village character, distinct from the Atlantic Seaboard's polished tourism infrastructure
- UK and European semigration targeting lifestyle over status, at 28% to 32% of sales
- Cape Point tourism route positioning, which supports nightly rates from December to March
...
Kalk Bay housing stock is three tiers, not one market: village core cottages at R3.2M to R5M, mountain-slope view homes at R4.5M to R7.5M, and waterfront stock above R6M. Built-area pricing runs from R22,000 per square metre to R65,000, and gross yield moves the other way, from 7.5% to 5%.

Location, view line, and building condition set the tier, and each carries a different risk-return profile. The split matters more here than in a uniform apartment suburb, because an unrenovated cottage and a renovated waterfront position sit in the same village but underwrite nothing alike.
...
Rental demand in Kalk Bay is split between long-let tenants and summer nightly guests, and the mix decides the return. Long leases average 18 to 24 months at R24,000 to R36,000 a month, while December to February Airbnb rates reach R2,500 to R4,500 a night at 65% to 80% occupancy.
...
Mixed-strategy math: Two-bedroom village cottage rented long-term year-round at R26,000 monthly = R312k annual. Same cottage using mixed strategy: 8-month long-term lease May-December at R24,000 = R192k, plus 4-month Airbnb January-April averaging R2,800 nightly at 65% occupancy = R224k, totaling R416k annual (+33% versus long-term only). However, mixed strategy incurs higher management costs (Airbnb takes 15-18% versus 9% for long-term) and turnover friction (cleaning, restocking, maintenance between tenants). Run the reverse case first. Four winter months on Airbnb at R1,600 to R2,400 nightly and 35% to 45% occupancy gross roughly R67,000 to R130,000, against R96,000 of contracted long-let rent at R24,000 a month across the same period. The nightly leg beats the lease only at the top of that range, and it carries the cleaning, platform, and vacancy risk on top. That asymmetry is the whole argument for placing the lease in winter and the nightly rate in summer.

![Kalk Bay Main Road with colorful shops and mountain backdrop](https://upload.wikimedia.org/wikipedia/commons/8/81/Main_Road_and_Beaufort_Cottage_in_Kalk_Bay_-_Cape_Town_1880.jpg)
...
Capital appreciation in Kalk Bay is steady rather than explosive, at roughly 4.2% CAGR between 2016 and 2026 against 5.1% on the Atlantic Seaboard. Exit timing carries more weight than the trend: properties listed September to February sell about 40% faster than winter listings, and unrenovated stock waits 180 to 280 days.
...
Transaction costs reduce net proceeds: transfer duty (3-13% sliding scale), agent commission (5-7.5% seller-paid), compliance certificates (electrical, plumbing, beetle, gas totaling R8k-R15k), and capital gains tax for foreign sellers (effectively 16-18% of profit). R4.2M purchase sold at R5.1M (R900k gain) incurs R144k-R162k CGT, plus R255k-R382k agent commission, netting R4.6M-R4.7M after costs. Non-resident sellers meet one further mechanic at exit. On a disposal above R2 million by a non-resident, the conveyancer withholds against the purchase price and pays it to SARS: 7.5% where the seller is an individual, 10% for a company, 15% for a trust. On that R5.1M sale the withholding is roughly R383,000 for an individual, an advance against the CGT bill, not an extra tax, but it parks cash committed elsewhere. The R2 million primary residence exclusion does not reach an investment cottage, and the 40% inclusion rate for individuals becomes 80% inside a trust or company.
...
Kalk Bay sits between Muizenberg and Simon's Town on price and character, and the comparison is really about tenant profile. Village entry runs R3.2M to R7M against Simon's Town at R2.8M to R5.5M, while Atlantic Seaboard positions demand R8M to R25M for gross yields of 8% to 10% in peak season only.

| Comparison area | Entry price band | Gross yield | Tenant pull |
| --- | --- | --- | --- |
| Kalk Bay | R3.2M - R7M | 6 - 7% | Semigrators, creatives, remote workers |
| Simon's Town | R2.8M - R5.5M | 6 - 7% | Naval employment, families |
| Fish Hoek | R3.5M - R6M | 6 - 7% | Local families, retirees |
| Constantia, Bishopscourt | R8M+ | 3.8 - 4.5% | Luxury long-let, corporate |
| Camps Bay, Clifton | R8M - R25M+ | 8 - 10% peak | Holiday tourism, seasonal |
...
Kalk Bay amenities are unusually walkable for Cape Town: harbour, Main Road restaurants, galleries and the Metrorail station sit inside a 500-metre radius, so a car-free tenant can live here. The gap is retail, because no full-line grocer trades in the village and a parking bay adds R2,000 to R4,000 a month.

| Amenity | Reach from the village | Rental effect |
| --- | --- | --- |
| Harbour, restaurants, galleries, station | Within 500 m on foot | Widens the pool to car-free tenants |
| Fish Hoek Checkers, hospital | About 10 minutes by car | Keeps Kalk Bay a lifestyle, not family, base |
| Dedicated parking bay or garage | On-plot where it exists | R2,000 to R4,000 a month premium |
| Boulders Beach, Simon's Town | About 10 minutes by car | Supports summer nightly rates of R2,500 to R4,500 |
| Cape Point Nature Reserve | About 25 minutes by car | Extends the visitor season beyond the village |
...
Bond financing for foreign buyers is typically capped near 50% of the purchase price, so half the ticket arrives as offshore capital, and is priced 1.5% to 2.5% above prime, which has stood at 10.50% since the May 2026 repo increase to 7.00%. That puts a non-resident bond at roughly 12.0% to 13.0%. Cash purchases avoid financing costs and position buyers for faster closing and stronger negotiation leverage, particularly for distressed or quick-sale opportunities.
...
Insider tip: ask the seller for the compliance certificates from their own purchase, not only the ones being issued for your transfer. Kalk Bay cottages are old enough that an electrical certificate is often re-issued after a partial rewire, and setting two certificates five or ten years apart side by side shows which circuits have actually been touched. The same comparison works on the beetle certificate, where repeat treatment of the same roof timbers is the tell that the problem was managed rather than fixed.
...
Kalk Bay suits lifestyle-motivated offshore investors who want authentic Cape village character at R3.2M to R7M, with 6% to 7% gross yields built from a winter long-let and a summer nightly rate. The trade is maintenance: heritage cottages absorb R35,000 to R50,000 a year before any major roof or damp work.

Target investors: UK and European buyers drawn to fishing village atmosphere, walkable coastal lifestyle, and creative community vibe willing to accept higher maintenance on heritage buildings and seasonal rental fluctuations in exchange for authentic village living experience.
