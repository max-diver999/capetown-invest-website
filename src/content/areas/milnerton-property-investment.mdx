...
## How should you underwrite Milnerton?
...
## What do the 2025 to 2026 numbers say about Milnerton?
...
The core of the Milnerton thesis is adjacency: it captures Century City demand at a coastal-suburb price. Built area trades at roughly R18,000 to R32,000 per square metre against R80,000 to R180,000 on the prime coast, while modelled net holds near 5% where the prime coast frequently sits under 3%. The table below frames that trade.
...
## What are the pros and cons of investing in Milnerton?

Every area carries trade-offs, and Milnerton's are specific rather than generic: salt air, West Coast wind, and a stock mix in which a compact apartment near Century City and a beachfront flat on the lagoon behave nothing alike. Against that sit modelled 7% gross and 5% net. The table below balances the two sides.
...
Insider tip: ask for the body corporate's last exterior painting date and its reserve fund balance in the same question. Salt air puts Table Bay blocks on a repaint and balustrade cycle far shorter than an inland scheme, and the building that has deferred it is the one that raises a special levy in your second year, which can absorb most of a year's modelled 5% net.
...
## Which Milnerton property fits your investment goal?
...
| Profile | What Milnerton offers | Yield vs growth (modelled) | Best buyer fit |
| --- | --- | --- | --- |
...
## Which buyer profile fits Milnerton?
