...
## How should you underwrite Woodstock?
...
## What do the 2025 to 2026 numbers say about Woodstock?

Anchor any Woodstock thesis in the data before you evaluate a single listing. The table below frames the suburb's value and income profile against the wider city: a MODELED 8.0% gross and 6.0% net on a compact apartment, entry tickets often below R2.2m against a Cape Town median near R1.9m, and a City Bowl market that turned over about R11.3bn in 2025. Read it as the baseline each individual street has to justify.
...
Woodstock's regeneration runs through its creative district, and the Old Biscuit Mill is the anchor. Roughly a decade of industrial-to-creative conversion turned a low-value manufacturing belt immediately east of the CBD into an address tenants choose rather than settle for, and that shift is what carries a MODELED 6.0% net off entry prices below R2.2m. Three structural forces combine to lift demand off that low base.
...
## What are the pros and cons of investing in Woodstock?
...
## How do foreign buyers approach Woodstock?
...
The two practical considerations are financing and due diligence. Non-residents typically face tighter loan-to-value limits from South African banks, often financing around half the purchase price locally and bringing the balance from offshore, recorded correctly at entry for clean repatriation at exit. In Woodstock specifically, the bigger consideration is on-the-ground verification, because a foreign buyer relying on listing photos cannot judge street-level variance remotely. Put numbers on the entry: at a R2.2m ticket a non-resident bond covers roughly R1.1m, transfer duty runs the SARS scale from nothing on the first R1,210,000 through the 3% and 6% steps above it, and conveyancing plus bond registration sit on top. At exit, a sale above R2 million by a non-resident triggers a withholding of 7.5% of the price for an individual seller, 10% for a company, and 15% for a trust, credited against capital gains tax rather than added to it.

## What risks should you plan for with Woodstock Property Investment Guide 2026, Value Yields?
...
Insider tip: on an industrial-to-residential conversion, ask for the occupancy certificate and the approved building plans, not only the sectional title deed. Woodstock carries stock that was converted informally, well before the current wave of properly permitted redevelopment, and a unit without an occupancy certificate is hard to bond, hard to insure at full replacement value, and slow to resell. Conveyancers catch it eventually. Catching it yourself before signature saves both the deposit and about six weeks.

## Which Woodstock property fits your investment goal?
...
Five things should stop a Woodstock offer rather than merely slow it down, and each is cheap to check before signature. Deeds-office sales in the same block are the reference point for most of them: an asking price more than 10% above recent transacted comparables needs a verifiable upgrade story rather than an agent's confidence.
...
## Which buyer profile fits Woodstock?
...
<FaqBlock items={[
  {
    question: "Is Woodstock a good property investment in 2026?",
    answer: "Woodstock is the City Bowl's value-and-regeneration play. It sits just east of the CBD with the lowest entry prices in the broader bowl, often below R2.2m for compact stock, and models around 8.0% gross and 6.0% net. Regeneration around the Old Biscuit Mill, the creative-district studios, galleries, and design firms, and ongoing infill development have lifted demand and rents. But Woodstock is uneven block by block, so due diligence on the specific street and building matters more here than anywhere else in the City Bowl. Figures are modelled and directional."
  },
  {
    question: "What rental yield does Woodstock offer?",
