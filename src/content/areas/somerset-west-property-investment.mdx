...
## How should you underwrite Somerset West?
...
## What do the 2025 to 2026 numbers say about Somerset West?

Anchor any Somerset West thesis in the data before you evaluate a single listing. The town's profile is a modeled 6% gross and 4.3% net on a family home, entry prices of roughly R18,000 to R32,000 per square metre, and a 45-minute drive to central Cape Town. The table below frames that income, price, and access picture against the wider region.
...
Somerset West yields more than the prestige suburbs because of price position and demand depth, not because it is a lesser address. A family home here models around 4.3% net against roughly 2.8% modeled in Constantia, and that gap comes from an entry band of R18,000 to R32,000 per square metre rather than from stronger rents. Three structural forces combine.
...
## What are the pros and cons of investing in Somerset West?

Every town carries trade-offs, and Somerset West is no exception. A working net near 4.3% and entry prices of R18,000 to R32,000 per square metre come with gradual rather than explosive capital growth and a 45-minute reach to the metro core. The table below balances the value and income strengths against the realistic drawbacks.
...
## How do foreign buyers approach Somerset West?

Non-residents buying in Somerset West face two hard limits rather than a ban. South African banks typically lend up to about 50% of the price to a non-resident, so roughly half the purchase price has to arrive as offshore capital, introduced through an authorised dealer and recorded at entry. On the way out, section 35A withholding applies to any sale above R2,000,000 by a non-resident seller: 7.5% of the price for an individual, 10% for a company, and 15% for a trust, withheld by the conveyancer and credited against the final capital gains assessment. Transfer duty follows the same SARS scale as for locals, with nothing payable below R1,210,000 and 3% on the slice above it, and no foreign buyer surcharge at all, unlike the UK's 2% or Singapore's 60%. Budget the withholding as a cash-flow event rather than a tax cost.

The two practical considerations are financing and currency. Because local lending to non-residents stops near half the price, the practical question is how much offshore capital you can transfer and record cleanly. Record every inward transfer through an authorised dealer, because that paper trail is what allows the proceeds to leave again when you sell. The full process, including financing and exchange-control recording, is covered in [Buy Cape Town Property as a Foreigner](/guides/buy-cape-town-property-foreigner/).

## What risks should you plan for with Somerset West?
...
Insider tip: in Somerset West the letting year runs on the school calendar, not the tourist one. Family tenants sign around the December to January changeover so children start the academic year in place, which means a home that falls vacant in March can wait months for a replacement at the same rent. Ask the agent when the current lease ends before you offer, and if it expires mid-year, price that vacancy into the modeled 4.3% net rather than assuming a same-month reletting.

## Which Somerset West property fits your investment goal?
