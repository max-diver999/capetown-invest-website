---
title: "Claremont Property Investment 2026: 6% Gross, 4.2% Net"
description: "Claremont apartments model 6% gross and 4.2% net at R30k-50k per sqm. Cavendish Square retail and the rail interchange make it the southern suburbs income play."
pubDate: 2026-06-17
...
**Insider tip: read the reserve fund before you read the rental appraisal.** In Claremont the gap between a 6% gross and a 4.2% net apartment is almost entirely the body corporate levy, and the levy you inherit is decided by a reserve fund most buyers never open. Cape Town Invest asks for three documents before any offer on a Claremont sectional title unit: the current levy schedule, two years of body corporate financials, and the most recent AGM minutes. A scheme with a thin reserve in a building over thirty years old will eventually special-levy for lifts, roofs or plumbing, and one special levy can erase a full year of net income on a R2.5m unit. Blocks within a short walk of Cavendish Square and the rail interchange also re-let faster after a vacancy, so walkability inside the suburb protects both the rent roll and the exit price.
