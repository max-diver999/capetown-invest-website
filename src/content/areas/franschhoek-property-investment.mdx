...
## What do the 2025 to 2026 numbers say about Franschhoek?
...
Franschhoek yields less than value-led Paarl because price position and demand type, not quality of life, drive the numbers. A luxury home in the valley models around 5% gross and 3.5% net, while Paarl reaches roughly 4.2% net from entry prices of R15,000 to R28,000 per square metre against Franschhoek's R30,000 to R55,000. Three structural forces combine to produce that gap.
...
## What are the pros and cons of investing in Franschhoek?

Every town carries trade-offs, and Franschhoek is no exception. Prestige and genuine scarcity buy gradual capital growth in a valley of around 17,000 residents, while a modeled net near 3.5% and a thin long-let tenant pool are the price of that address. The table below balances the prestige and growth strengths against the realistic drawbacks.
...
## How do foreign buyers approach Franschhoek?

The practical considerations are financing, currency, and liquidity. Expect a local bond of roughly 50 percent as a non-resident, with the remainder funded from your own offshore capital. Keep the authorised dealer confirmation for each transfer, since exchange control treats the introduction record as the basis for taking money out. Because Franschhoek is small and tightly held, budget a longer holding period and a slower resale than Paarl or Stellenbosch. The full process, including financing and exchange-control recording, is covered in [Buy Cape Town Property as a Foreigner](/guides/buy-cape-town-property-foreigner/).

## What risks should you plan for with Franschhoek?

Franschhoek is transparent but thinner than the larger winelands towns, and it carries specific risks worth modeling before any Offer to Purchase. Most of them trace back to two numbers: the roughly 1.5 percentage point gap between a modeled 5% gross and 3.5% net, and a resale market serving a town of around 17,000 people. The table below maps the main ones against a mitigation.
...
## Which Franschhoek property fits your investment goal?
...
## Which buyer profile fits Franschhoek?
