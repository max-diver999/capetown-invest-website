...
Beyond the scheme, the purchase mechanics are the same as anywhere in South Africa, and a foreign buyer faces no surcharge and no ownership restriction. What that costs and how the money moves is covered by the [pillar investment guide](/guides/cape-town-property-investment-guide/) rather than repeated here, and the current municipal rules for nightly letting are tracked in the [short-term letting by-law guide](/guides/cape-town-str-bylaw-2026-registration/).
