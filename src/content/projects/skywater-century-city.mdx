...
readingTime: 11
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356439/more-group/capetown/projects/skywater-century-city.jpg"
...
## How should you underwrite SkyWater Century City?
...
The two figures to internalise first are the eight-month sell-out and the under-construction status. The sell-out tells you demand for the precinct is genuine, which supports the rental thesis. The construction status tells you the structural risks of off-plan still apply: completion timing, the final body corporate levy, and the finished product remain estimates until handover. The yield figures, all modelled, then frame the kind of return SkyWater produces, an income play in the mid 5% to low 6% net range, not a coastal appreciation bet.
...
The discipline is to separate the lifestyle appeal of canal views from the rent the market will actually pay. Pull live comparable rents for canal-facing units of the same size in Century City, apply a realistic vacancy allowance, and rebuild net yield from the roughly 7.7% modelled gross after levies, rates, and management at around 8% to 10% of rent. The view sells the unit; the comparable rent underwrites the deal.
...
## What are the pros and cons of buying at SkyWater?

SkyWater's pros and cons sort along one axis: precinct quality against off-plan timing risk. Rabie's record in the precinct since 1997, canal-facing aspects, and a MODELED 7.7% gross support the income case, while an unfinished building, an estimated levy, and the Century City supply pipeline sit opposite. Weigh the two lists against your holding period before you decide.
...
- Income-led return profile, with modelled gross yield around 7.7% backed by corporate and professional rental demand and typically low vacancy.
...
Treat the specific unit as its own deal, regardless of the project's reputation or the eight-month sell-out. Off-plan buyers inherit whatever the sectional plan, the NHBRC enrolment, and the first body corporate budget actually say, and a developer name does not change any of it. The checklist below runs in order of what costs most to discover late.
...
- Underwrite rent against live comparables for canal-facing units of the same size, then rebuild net yield from the roughly 7.7% modelled gross after levies, rates, management, and a realistic vacancy allowance.
...
<FaqBlock items={[
  ...
  {
    question: "How much can SkyWater Century City yield?",
    answer: "SkyWater is positioned as an income-led buy. In line with Century City stock, a modelled gross yield of around 7.7% is a reasonable starting point, settling into the mid 5% to low 6% net range after levies, rates, management at roughly 8% to 10% of rent, and a realistic vacancy allowance. These figures are modelled and directional, not a forecast or a guaranteed return. Rebuild the yield on net, not gross, using live comparable rents for the same precinct and unit type before you commit."
  },
  {
    question: "Can foreigners buy at SkyWater Century City?",
    answer: "Yes. South Africa places very few restrictions on foreign ownership, so a non-resident can buy a sectional title apartment at a Rabie scheme like SkyWater with no foreign buyer surcharge, unlike the UK 2% surcharge or Singapore's roughly 60% additional duty. A non-resident who introduces funds cleanly can usually finance up to 50% of the price with a South African bond and fund the rest offshore, recording the offshore capital correctly for future repatriation under exchange control."
