...
SkyWater's pros and cons sort along one axis: precinct quality against off-plan timing risk. Rabie's record in the precinct since 1997, canal-facing aspects, and a modelled 7.7% gross support the income case, while an unfinished building, an estimated levy, and the Century City supply pipeline sit opposite. Weigh the two lists against your holding period before you decide.
