...
ONEONR is Blok's 20th development and first De Waterkant scheme at 1 Rawbone Street, delivering 74 units from R1,995,000 studios to R16,695,000 penthouses with ground break August 2025 and Q3 2027 handover, where the investment case is location scarcity plus brand delivery rather than guaranteed yield.
...
ONEONR buyers should model MODELED long-let gross near 4% to 5.5% on De Waterkant comparables, compressing to roughly 3% to 4.5% net after body corporate levy, municipal rates, vacancy, and management, with studios at mid price near 6.1% to 7.9% gross directional only and penthouses nearer 4.6% to 6.2% gross before premium levies.
...
**Atlantic Seaboard income buyer:** Targets a one-bedroom or two-bedroom apartment for long-let near Green Point and the Waterfront; underwrite on net yield after levy and rates using the [Cape Town rental yield guide](/guides/cape-town-rental-yield-guide/).

**Design-led owner-occupier:** Wants Blok architecture in a walkable heritage pocket; accepts lower MODELED yield for lifestyle and scarcity, similar to buyers comparing [ONEHUNDREDONM](/projects/onehundredonm-sea-point/) on Main Road.

**Foreign cash buyer:** Introduces offshore capital with no buyer surcharge, plans the 30% deposit and typical 50% bond ceiling, and reads the [cost of buying guide](/guides/cost-of-buying-property-cape-town/) before reservation.

**Capital preservation buyer:** Focuses on upper-floor or penthouse stock for harbour and Table Mountain aspects; treats yield as secondary and verifies NHBRC warranty and defect liability in the sale agreement.
