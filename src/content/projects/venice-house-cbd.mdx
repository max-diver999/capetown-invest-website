...
<TldrBlock text="Venice House: Prospekt, 24 Burg Street, Cape Town CBD — 36 boutique units (studios, 1–2 bed, lofts, penthouses). Launch 4 Oct 2023 sold out; pricing ~R1.5m–R6m; build complete ~Q4 2024. Heritage facade, concierge, security, ground-floor coffee shop. UDZ accelerated depreciation for SA taxpayers — verify with accountant. Resale furnished/Airbnb-ready listings active. modelled CBD short-stay gross high single digits peak; net after ~20% mgmt + levies lower. Foreigners: no surcharge, 50% bond. Compare The Charlotte 20 Burg St. Yields modelled." />
