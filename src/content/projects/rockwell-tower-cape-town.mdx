...
readingTime: 12
heroImage: "https://commons.wikimedia.org/wiki/Special:FilePath/Tamboerskloof_From_Tafelberg_Road.jpg?width=1600"
heroAlt: "Tamboerskloof rooftops seen from Tafelberg Road"
...
The Rockwell is a 2009 mixed-use building of about 143 apartments on Prestwich Street, split between private sectional title stock and the Rockwell All-Suite Hotel pool. Long-let units model about 5% to 7% gross and 4% to 6% net after levies and management. The table below sets out the figures that shape any offer.
...
| modelled gross yield | About 5% to 7% | De Waterkant band |
| modelled net yield | About 4% to 6% | After levies and mgmt |
...
Hotel-pool ownership at The Rockwell changes the arithmetic before any tenant appears. Operator fees on pooled units run 15% to 25% of gross bookings, and that comes off the top of a modelled 5% to 7% gross long-let band, which is why pooled stock needs an operator statement rather than a brochure yield before you offer. Owner-use blackout dates and minimum rental participation clauses limit what you can do with the apartment yourself, and a furnished fit-out obligation is a capital cost that rarely appears in the asking price. A private sectional title unit in the same building carries none of that, but also none of the operator's booking engine, so it depends on the owner's own letting effort and the body corporate's conduct rules. Establish which of the roughly 143 doors you are buying first.
...
The Rockwell is an income-and-lifestyle City Bowl fringe play with modelled 5 to 7 percent gross long-let compressing to 4 to 6 percent net after levies and parking, stronger short-stay potential than [Harbour Arch](/projects/harbour-arch-amdec-foreshore/) Foreshore towers but with hotel competition inside the building where pooled units need operator statements before net yield.

| Strategy | Gross signal | Net risk |
| --- | --- | --- |
| Long-let professional | modelled 5% to 7% | Levies + parking |
| Managed hotel pool | Operator-dependent | Fees and calendar |
| Owner short-stay | Seasonal uplift | STR and body corporate rules |

Modelling The Rockwell honestly means starting from the modelled 4% to 6% net band rather than the 5% to 7% gross, because the spread is absorbed by body corporate levies covering the indoor pool and gym, a basement parking bay across four levels, and letting or operator fees. The building dates from about 2009, so the body corporate has a real financial history: two years of statements show whether special levies have been raised and what the reserve fund holds against a lift or facade item. Sizes supply the other half of the model, with two-bedroom apartments cited around 81 m², which is what lets you rebuild price per square metre against De Waterkant resale comparables instead of trusting an asking price. Non-residents finance up to about 50% locally and bring the balance offshore.
...
| Format | Size signal | Resale band | modelled gross |
| --- | --- | --- | --- |
...
modelled De Waterkant net long-let often lands near 4% to 6% after levies, rates, and parking — hotel-pooled units need operator statements before net yield.
...
| Scheme | Location | Era | Pool | modelled net long-let |
| --- | --- | --- | --- | --- |
...
Confirm Prestwich Street unit, hotel-pool status, levy, and parking bay on title. Neighbourhood context: [De Waterkant guide](/areas/de-waterkant-property-investment/). Compare [ONEONR](/projects/oneonr-de-waterkant/). STR plans: [short-term rental rules](/guides/short-term-rental-rules-cape-town/). If you are buying from abroad, the [foreign buyer guide](/guides/buy-cape-town-property-foreigner/) covers FICA, exchange control and the bond cap in sequence. [Request a shortlist](/get-shortlist/) for De Waterkant resale screened to your brief.
...
<FaqBlock items={[
  ...
  {
    question: "What rental yield does The Rockwell model?",
    answer: "modelled De Waterkant gross about 5% to 7%, net about 4% to 6% long-let after levies. Hotel-pooled units need operator fees deducted from net."
  },
  {
    question: "What amenities does The Rockwell offer?",
