...
readingTime: 11
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356421/more-group/capetown/projects/on-park-century-city.jpg"
...
## What are the pros and cons of a resale at on park?

Resale at On Park trades the entry discount of off-plan for certainty. The scheme is sold out and occupied, so the 121 apartments come with a levy history, an audited body corporate file, and achieved rents you can read before you offer. What you give up is the staged payment profile and the launch price. Weigh the two lists below against that single trade.
...
The honest summary is that On Park's completed status removes most estimate risk and gives you verifiable numbers, but the return still depends on the price you pay, the body corporate's health, and your rent assumptions. Work it through. At the roughly 7.7% modelled gross that Century City stock supports, a levy and rates load near a quarter of gross rent, management at 8% to 10%, and one vacant month a year land the net in the mid 5% to low 6% band. Pay 10% over the comparable resale price and that net falls by roughly half a percentage point, which is most of the margin you were buying the scheme for in the first place. The features are a genuine advantage rather than a guarantee, and none of them compensate for an entry price set by competition instead of by the accounts.

---

## What belongs on your due diligence checklist?

Treat the specific unit as its own deal, and use the completed status to your advantage by demanding real documents rather than assurances. Everything on this list already exists somewhere in the body corporate's files or the deeds office, which is the whole point of buying occupied stock. A seller or agent who cannot produce an item within a few working days is telling you something useful about how the scheme is run.
...
- Rebuild net yield from the roughly 7.7% modelled gross on conservative, verified rent after levies, rates, management, and vacancy.
...
The recurring lesson is that On Park's risks are manageable precisely because the numbers exist. What undoes a resale deal is usually overpaying into a compressed yield, skipping the body corporate accounts, or taking the EDGE and backup-power headlines on trust rather than verifying them. Sequence the checklist against your money. The body corporate accounts and the levy trend come first, because a levy rising faster than rent quietly resets the mid 5% to low 6% net band every year you hold. Funding comes second: with the non-resident bond ceiling at about 50% of value, half the purchase arrives from offshore and must be recorded through an authorised dealer bank so that capital and any gain can leave again on sale. Transfer duty comes third, payable in rand before registration, nothing on the first R1,210,000 and stepping through 3%, 6%, 8%, 11%, and 13% above it.
