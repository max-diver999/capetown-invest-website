...
The honest summary is that On Park's completed status removes most estimate risk and gives you verifiable numbers, but the return still depends on the price you pay, the body corporate's health, and your rent assumptions. Work it through. At the roughly 7.7% MODELED gross that Century City stock supports, a levy and rates load near a quarter of gross rent, management at 8% to 10%, and one vacant month a year land the net in the mid 5% to low 6% band. Pay 10% over the comparable resale price and that net falls by roughly half a percentage point, which is most of the margin you were buying the scheme for in the first place. The features are a genuine advantage rather than a guarantee, and none of them compensate for an entry price set by competition instead of by the accounts.
