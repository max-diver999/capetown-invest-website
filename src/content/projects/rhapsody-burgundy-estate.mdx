...
Stop when estate-wide averages replace the specific sectional title levy on your unit, when EDGE certification is assumed without written confirmation, when short-let is modeled without body corporate conduct rules, when Finwood and Century City supply is ignored in rent projections, or when transfer duty above R2 million is omitted from yield math.
