...
Stop when deposits are marketed as Amdec Hout Bay without Harbour Arch or La'Mare paperwork, when yield claims use Camps Bay village averages on R2 million harbour stock, when NHBRC enrolment is missing at reservation stage, or when Chapman's Peak commute seasonality is ignored for CBD tenant underwriting.
