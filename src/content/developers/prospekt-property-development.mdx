...
A managed central-city aparthotel unit plays one specific role: it is the operating-income sleeve, correlated with Cape Town's tourism and business travel cycle rather than with residential rent. That genuinely diversifies against a long-let suburban apartment, whose demand tracks salaries and semigration. It does not diversify against a short-let apartment you already own on the Atlantic Seaboard, because both fill from the same visitor pool in the same summer weeks. Buyers often mistake the second case for the first.

Size the position accordingly. Boutique scale cuts both ways: a 35-unit building like The Charlotte is easy to manage and hard to exit, because your eventual buyer is another investor willing to inherit the same management agreement rather than an owner-occupier family. That narrows the resale pool and argues for a smaller allocation than you would take in a deep, liquid suburb.
