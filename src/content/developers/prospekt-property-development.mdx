...
readingTime: 12
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356269/more-group/capetown/developers/prospekt-property-development.jpg"
...
## How should you underwrite Prospekt?

Prospekt is a Cape Town studio led by Christiaan Heunis that builds boutique aparthotels through City Bowl infill, including Venice House and The Charlotte, a 35-unit building on Burg and Hout Streets. Underwrite the operator and the occupancy rather than the address, and plan around the 50% non-resident bond ceiling.

Instead of master-planning suburbs, Prospekt takes small central-city sites and buildings in the [Cape Town City Bowl](/guides/cape-town-city-bowl-property-investment/) and turns them into managed, hotel-style accommodation. [The Charlotte](/projects/the-charlotte-cape-town/) is the clearest example of the format.

The Cape Town CBD is a supply-constrained, high-demand location with strong visitor and business traffic, and a professionally managed aparthotel lets an overseas owner participate in that demand without running the property day to day. That is a different investment logic from a buy-and-let suburban apartment: you are buying into an operating model, not just four walls. The catch, and the theme of this guide, is that an operating model introduces its own risks, the management agreement, the operator's performance, and the regulatory environment for short stays, all of which you must vet before the brand or the brochure persuades you.
...
## What numbers define Prospekt and the aparthotel model in 2026?
...
The aparthotel model offers hands-off central-city accommodation: an operator runs bookings, housekeeping and guest services, and the owner of a unit in a 35-unit building such as The Charlotte takes a share of trading income after fees. What it costs is control, because a management agreement replaces a 12 month lease.

The Cape Town City Bowl is a tight, walkable, high-demand zone where new development sites are scarce, so infill schemes that add boutique accommodation tap into both visitor and business demand. For an overseas owner in particular, that removes the operational burden which makes remote short-let ownership difficult.
...
The Urban Development Zone allowance is a tax provision that permits accelerated depreciation on qualifying property inside designated regeneration zones, historically including parts of the Cape Town CBD. Verify it with a registered tax practitioner, because eligibility, the deduction profile and the legislated sunset window all move independently of the 15% VAT question.

In principle, an investor buying a qualifying unit in a qualifying central-city building can claim a deduction that improves after-tax returns, sometimes materially over the allowance period.

Cape Town Invest worked example: a R2,500,000 City Bowl resale attracts transfer duty of about R68,854 on the SARS scale, nothing on the first R1,210,000, 3% on the slice to R1,663,800, 6% to R2,246,600 and 8% above that. The same unit bought new from a VAT-registered developer carries 15% VAT inside the price and no duty at all, so the two routes are not comparable on headline price. A UDZ allowance, where the building and the buyer qualify, then sits on top of whichever route applies, which is why the eligibility letter from your accountant matters more than the brochure line. Model the deal both ways before you sign, because on a 35-unit scheme the difference between duty and VAT treatment can exceed a full year of net operating income.
...
## What are the pros and cons of buying Prospekt development?

Prospekt's pros and cons both flow from the same feature: a managed operating model in a supply-constrained City Bowl. Convenience, occupancy depth, and a possible UDZ allowance sit on one side; operator dependence, short-stay regulation, and fee drag sit on the other. Read the two lists as one trade rather than as a scorecard.
...
Due diligence on an aparthotel unit runs wider than a normal apartment purchase, because you are underwriting an operating business as well as a title deed. Three numbers anchor the work: the 50% non-resident bond ceiling, the 75% special resolution threshold under the STSMA, and the 15% VAT that replaces transfer duty on new stock.

Work through the list below in order. First, the 50% non-resident bond ceiling sets how much cash you must land in South Africa before transfer. Second, the levy and reserve position, because under the STSMA a special resolution needs 75% support, so the minutes of the last two general meetings show what the body corporate is about to commit owners to. Third, the purchase tax route, since a new unit sold by a VAT-registered developer carries 15% VAT in the price and no transfer duty, while a resale of the same unit attracts duty on the SARS sliding scale that begins above R1,210,000. Confirm which applies before you compare two schemes on price alone.
...
## How do foreign buyers approach Prospekt stock?
...
A managed central-city aparthotel is the operating-income sleeve of a portfolio, correlated with Cape Town's tourism and business travel cycle rather than with residential rent. Boutique scale cuts both ways, because a 35-unit building is easy to manage and hard to exit, and the 50% bond ceiling fixes the cash half of the ticket.

That sleeve genuinely diversifies against a long-let suburban apartment, whose demand tracks salaries and semigration. It does not diversify against a short-let apartment you already own on the Atlantic Seaboard, because both fill from the same visitor pool in the same summer weeks. Buyers often mistake the second case for the first.

Size the position accordingly. Your eventual buyer at The Charlotte is another investor willing to inherit the same management agreement rather than an owner-occupier family, which narrows the resale pool and argues for a smaller allocation than you would take in a deep, liquid suburb.

Two structural questions decide whether this can be a core holding or only a satellite one. Confirm whether the management agreement runs with the unit on resale, because a locked-in operator either supports the next buyer's price or caps it. Then confirm whether the scheme's conduct rules allow an owner to leave the rental pool and let long-term instead. That fallback is what protects the asset if short-stay regulation tightens, and its absence is a concentration risk dressed as convenience.
