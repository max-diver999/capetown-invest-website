...
Nothing in South African law blocks a non-resident from owning a Blok section outright, and there is no equivalent of the UK 2% non-resident surcharge. The friction sits in funding and in exit paperwork, not in eligibility.

On funding, local banks generally cap non-resident lending at about 50% loan-to-value, so a prime Sea Point or De Waterkant apartment needs roughly half the price introduced from offshore. Bring those funds in through a South African bank with the inward flow properly recorded and keep the confirmations. That record is what lets the capital, and later the gain, leave again. Money that arrives informally becomes a repatriation problem years afterwards, when the trail is hardest to reconstruct.
