...
Blok apartments underwrite as a growth play, not an income one: modelled gross in Sea Point and De Waterkant is roughly 5% to 6%, and net lands 1 to 2 points lower once levy, rates, a letting fee of 8% to 10% and vacancy come off. Build that figure from the scheme budget.

Blok deliberately operates in supply-constrained locations close to the coast and the CBD, where there is little greenfield land and where scarcity supports both rents and resale value. That is a different investment logic from an inland precinct play: instead of buying into managed scale, you are buying into design and location scarcity. A strong design reputation and a prime address lower some risks but never remove the need for deal-specific due diligence on the exact scheme, particularly its body corporate budget.
...
Blok's roughly 20 delivered buildings by the 2025 ONEONR launch protect against two off-plan risks, delivery failure and quality drift. What the developer's pedigree does not cover is the levy: fibre, solar, backup power and rooftop facilities carry running costs that pull net well below the 5% to 6% modelled gross.

A developer that has delivered around 20 buildings in the same tight geography has been through the planning, construction, and handover cycle repeatedly. For an off-plan buyer, that lowers the two risks that most often damage off-plan returns: delivery risk and quality risk.
...
Off-plan Blok stock is bought on staged payments at an early-phase price, in suburbs where finished prime apartments rarely come cheap. Scarcity is genuine here, because the developer builds small buildings on an Atlantic Seaboard with little new land. Underwrite rent at the conservative end of the 5% to 6% modelled gross.
...
Due diligence on a Blok scheme is deal-level work that the developer's brand does not do for you. Approved plans, the build programme, the projected body corporate levy, the reserve fund plan and the sectional title register all need checking for the exact unit, with net yield rebuilt from the 5% to 6% modelled gross.
...
Blok apartments occupy the growth and lifestyle slot in a Cape Town portfolio, not the income slot, because modelled gross of about 5% to 6% on the Atlantic Seaboard is below what inland income stock produces. Many investors pair an inland unit as the income anchor with a coastal apartment held for growth.

Income-led investors often favour inland suburbs and managed precincts, while growth, trophy, and lifestyle buyers favour the Atlantic Seaboard. To see where Blok's current stock fits against the wider market, read our project page for [ONEONR in De Waterkant](/projects/oneonr-de-waterkant/), the [Atlantic Seaboard investment guide](/guides/atlantic-seaboard-property-investment-guide/), our [Sea Point suburb guide](/areas/sea-point-property-investment/), and our roundup of [new developments in Cape Town for 2026](/guides/new-developments-cape-town-2026/) before you shortlist a scheme.
