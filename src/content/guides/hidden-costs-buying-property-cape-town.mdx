---
title: "The Hidden Costs of Buying Property in Cape Town 2026"
...
Transfer duty is the single largest once-off cost on most Cape Town resales, and it surprises buyers in three specific ways: the brackets are progressive, new builds are taxed differently, and the rand amount moves with the exchange rate for anyone paying in foreign currency. Each one is simple to model in advance and expensive to discover late.

Progressive brackets bite harder than price alone. Duty is calculated on slices of value rather than the whole price at one rate, and the jump to 11% on the portion above R2,994,800 is where most mid-market Cape Town deals land. On a R2,000,000 resale duty runs about R33,800; at R3,000,000 about R107,000; at R5,000,000 about R327,000; and at R10,000,000 about R877,000. Negotiating R50,000 off the price therefore saves capital and duty together, which matters more than the discount looks. Below R1,210,000 no duty is payable at all. Buyers who round the figure in their heads, or who assume a flat percentage, routinely under-budget the cash they need on transfer day, because none of this can be added to the bond.
...
Cash buyers skip bond costs entirely. Financed buyers face a second fee stack that agents rarely put on the first page of the brochure: a separate bond attorney charging on a scale similar to the transfer fee, a bank initiation fee, compulsory bond life cover for the term of the loan, and valuation charges that some banks absorb and others pass on.
...
## What belongs on your hidden costs checklist?

A Cape Town hidden costs checklist is nine questions long, and each one has a number attached: the exact transfer duty bracket, VAT or duty, conveyancing all-in with 15% VAT, the bond stack, levy and special-levy history, rates clearance, FICA and FX readiness, year-one maintenance, and short-let rules.
...
Cape Town is transparent by global standards, with no foreign-buyer surcharge and clean deed registration. The hidden costs are quieter: progressive transfer duty that reaches 11% above R2,994,800, levy politics, municipal timelines, bond life insurance, short-let compliance, and the maintenance reality of coastal sectional title, which arrives as a special levy rather than an invoice.
