...
The full suburb-by-suburb table, including Observatory, the City Bowl, Green Point and the inland corridors, is owned by the [highest-yield suburbs guide](/guides/highest-rental-yield-suburbs-cape-town/). For how the coastal strip compares on price and demand rather than on yield, see the [Atlantic Seaboard guide](/guides/atlantic-seaboard-property-investment-guide/).
...
Three of those four rows are costs, which is why an STR plan that looks two points better on gross can land behind a long lease on net. The full economics, including the December-to-March concentration and what a realistic annual occupancy assumption looks like, belong to the [Airbnb investment guide](/guides/airbnb-investment-cape-town-guide/), and the long-let mechanics to the [long-term rental guide](/guides/long-term-rental-cape-town-guide/).

What matters at this level is the underwriting order. Model the long lease first and treat it as the floor, because it is the number that survives a body corporate vote or a by-law change. A growing number of sectional title schemes restrict short-stay letting, and a scheme can do so by 75% special resolution, so an STR plan is a permission you hold rather than a right you own. The [short-term letting rules guide](/guides/short-term-rental-rules-cape-town/) tracks the City's by-law separately from the scheme's own conduct rules.
...
Yield is one input to the decision rather than the decision itself. For the wider case, including capital growth, currency and the risks that do not show up in a rent-to-price ratio, see [whether Cape Town property is a good investment](/guides/is-cape-town-property-good-investment-2026/).
