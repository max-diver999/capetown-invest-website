...
description: "Modelled Cape Town rental yields by suburb: gross vs net for Sea Point, Camps Bay, City Bowl, Observatory and Woodstock, plus a worked net yield example."
pubDate: 2026-06-17
...
faq:
  - question: "What rental yield can you get in Cape Town?"
    answer: "Modelled gross yields in Cape Town typically run from about 6.5% to 9.7% depending on the suburb, with net yields after vacancy, levies, rates and maintenance roughly 4.4% to 7.5%. These figures are directional models, not guarantees, and shift with purchase price, occupancy and management costs."
  ...
  - question: "What is a realistic net yield on a Sea Point apartment?"
    answer: "On a modelled R4 million Sea Point apartment renting at about R32,300 a month, gross yield is roughly 9.7%. After vacancy, levies, rates, insurance and maintenance the net is near 7.5%, falling to around 6.6% once you add a 10% management fee. This is illustrative, not a quote."
  - question: "Does Cape Town rental yield beat capital growth?"
    answer: "For many investors Cape Town is a balanced play: mid-single-digit modelled net yield plus the potential for rand-denominated capital growth and a currency angle for hard-currency buyers. High-yield suburbs like Observatory lean to income, while Camps Bay leans to capital value and lifestyle over yield."
---
import TldrBlock from '../../components/TldrBlock.astro';
import FaqBlock from '../../components/FaqBlock.astro';

export const faqItems = [
  { question: "What rental yield can you get in Cape Town?", answer: "Modelled gross yields in Cape Town typically run from about 6.5% to 9.7% depending on the suburb, with net yields after vacancy, levies, rates and maintenance roughly 4.4% to 7.5%. These figures are directional models, not guarantees, and shift with purchase price, occupancy and management costs." },
  ...
  { question: "Are these Cape Town rental yields guaranteed?", answer: "No. Every yield figure in this guide is modelled and directional, built from typical purchase prices, rents and cost assumptions for each suburb. Actual returns depend on the specific property, its price, occupancy, levy level and how it is managed. Treat the numbers as a planning framework, not a promise." },
...
| Suburb | Modelled gross yield | Modelled net yield | Letting profile | Why the yield sits here |
|---|---|---|---|---|
...
The single biggest lever on Cape Town yield is the letting model. Short-term rental (Airbnb-style or serviced) can lift gross yield in tourist suburbs, but it changes the whole cost and risk profile. The table compares the two on a modelled basis.

| Factor | Short-term (STR) | Long-term lease |
|---|---|---|
| Modelled gross yield uplift | 2 to 4 points higher in tourist areas | Baseline |
...
A few insider checks protect your modelled yield from becoming a disappointment.
