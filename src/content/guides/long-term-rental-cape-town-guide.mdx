...
heroImage: "https://commons.wikimedia.org/wiki/Special:FilePath/Noordhoek_Beach_%28South_Africa%29.jpg?width=1600"
...
export const faqItems = [
  { question: "Is long-term rental a good investment in Cape Town?", answer: "On a modelled basis, long-term letting in Cape Town pairs a net yield of roughly 4.4% to 7.5% with steady, year-round demand fed by semigration and a deep tenant pool. It trades the seasonal upside of short-term letting for far lower vacancy, around 8% to 10%, and cheaper management at 8% to 12% of rent. These figures are directional models, not guarantees." },
...
Huur gaat voor koop, the rule that a sale does not break the lease, means a Cape Town buyer inherits the sitting tenant on the existing terms: same rent, same escalation, same end date, and the same deposit obligation. Read the full lease and 12 months of payment history during due diligence, not after transfer.
...
Long-term landlord setups in Cape Town are driven by how present you are. A hands-off foreign owner budgets 8% to 12% management plus 4 to 8 weeks of vacancy; a semigration landlord may self-manage at first; a portfolio builder stacks two long-lets in different nodes to diversify tenant type.
