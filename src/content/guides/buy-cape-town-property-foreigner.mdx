...
A foreign buyer can register either form in their own name, in joint names, or through a South African company or trust. The only meaningful restriction sits with agricultural land, where buying through a local entity is more common, and that rarely affects city or coastal residential purchases. For the investment angle on which form holds value best, [the metro investment guide](/guides/cape-town-property-investment-guide/) compares freehold houses against sectional-title apartments on yield and resale.
