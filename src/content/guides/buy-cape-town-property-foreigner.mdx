...
export const faqItems = [
  { question: "Can a foreigner legally buy property in Cape Town?", answer: "Yes. South Africa places no nationality restriction on residential property. A foreigner can own freehold (full title) or sectional title (apartment) in Cape Town in exactly the same way a citizen can, with their name registered on the title deed at the Deeds Office." },
  { question: "Do I need a visa or residency to buy in Cape Town?", answer: "No. Buying property does not require a visa, residence permit, or any physical presence in South Africa. Ownership and the right to live in the country are separate matters, so you can buy as a non-resident and visit on a normal tourist entry." },
  { question: "Is there an extra tax for foreign buyers in South Africa?", answer: "No. Unlike Singapore or Australia, South Africa has no foreign-buyer surcharge. Transfer duty is charged on the same sliding scale for everyone, and new-build purchases from a VAT-registered developer carry VAT instead of transfer duty rather than an added foreign levy." },
  { question: "What is FICA and why does it matter?", answer: "FICA is the Financial Intelligence Centre Act, South Africa's anti-money-laundering law. Your conveyancer and bank must verify your identity, address and source of funds before money moves. Preparing FICA documents early is the single biggest way to avoid delays." },
  { question: "How do I bring my money into South Africa to pay for the property?", answer: "Funds must enter through an authorised dealer, which in practice is a commercial bank licensed by the South African Reserve Bank. The bank records the inflow so the capital, plus a proportionate share of any future profit, can later be sent back out lawfully." },
  { question: "What is a non-resident endorsement on the title?", answer: "When a non-resident funds a purchase with foreign currency introduced through the banking system, the deed is endorsed non-resident. This endorsement is your proof that the money came from abroad and is the key that allows you to repatriate sale proceeds when you sell." },
  { question: "Can a foreigner get a bond (mortgage) in South Africa?", answer: "Yes, but local lending to non-residents is capped at roughly 50% of the purchase price under exchange-control rules. The remaining half must be brought in from abroad. Residents with a work visa and local income can sometimes access higher loan-to-value ratios." },
  { question: "Can I buy a Cape Town property without flying to South Africa?", answer: "Yes. A remote purchase is routine. You sign a power of attorney, usually notarised and apostilled in your home country, authorising a trusted representative or your conveyancer to sign the transfer and bond documents on your behalf." },
  { question: "How long does the transfer take and who registers it?", answer: "A conveyancer (transferring attorney) handles the process and lodges documents at the Deeds Office. From accepted offer to registration typically takes about 8 to 12 weeks, longer if a bond or exchange-control clearance adds steps." },
  { question: "What are the main costs on top of the purchase price?", answer: "Budget for transfer duty (on resale), conveyancing fees, Deeds Office registration, and bond registration costs if you finance. New developments fold 15% VAT into the price instead of transfer duty. See the cost guide for a full worked example." }
];
