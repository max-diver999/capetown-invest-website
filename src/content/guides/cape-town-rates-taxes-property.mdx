...
| Property value | Rateable value (after the R620,000 relief) | Annual rates (approx.) | Monthly rates (approx.) | Bill as a share of value |
| --- | --- | --- | --- | --- |
| R2,000,000 | R1,380,000 | R8,832 | R736 | just under half a percent |
| R3,000,000 | R2,380,000 | R15,232 | R1,269 | around half a percent |
| R5,000,000 | R4,380,000 | R28,032 | R2,336 | a little over half a percent |
| R10,000,000 | R10,000,000 (no relief above R8m) | R64,000 | R5,333 | the full tariff, 0.64 cents in the rand |
