...
This guide explains how to read the headline numbers, where Property24 and Loos fit in, and how to connect macro data to area selection. For the full investment thesis, continue with [the metro investment guide](/guides/cape-town-property-investment-guide/). For forward-looking bands, see the [Cape Town property market forecast 2026 to 2027](/guides/cape-town-property-market-forecast-2026-2027/).
