...
readingTime: 18
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356349/more-group/capetown/guides/non-resident-mortgage-cape-town.jpg"
faq:
...
Get those pieces in the right order and financing becomes process, not obstacle. The 50 percent bond, the offshore deposit, the FICA pack and the exchange control endorsement all fit together into a single clean structure that lets you own in Cape Town and repatriate your capital when you choose. If you are still comparing lenders, ask each originator for a written pre-qualification letter before you sign an Offer to Purchase. For the broader legal and currency context that sits around the loan, read our [South Africa exchange control guide](/guides/south-africa-exchange-control-property/) alongside this one.
