...
The rest of this guide breaks that verdict into evidence: what the long-term data actually shows, what returns are realistic, where the structural advantages sit, and the three risks that get glossed over in most sales pitches. For the full market context behind these figures, [the metro investment guide](/guides/cape-town-property-investment-guide/) is the hub that sits underneath this page.
