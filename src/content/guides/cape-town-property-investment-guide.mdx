...
Rabie clusters dominate the income thesis in [Century City](/guides/century-city-property-investment-guide/) and Burgundy Estate in Cape Town's northern suburbs, where master-planned precincts, canal or park frontage, and repeat sell-outs signal rental depth. Blok clusters dominate scarcity on the [Atlantic Seaboard](/guides/atlantic-seaboard-property-investment-guide/), where small-format sectional title in walkable streets trades lower MODELED yield for liquidity and capital preservation. [Amdec](/developers/amdec-property-investments/) anchors the Foreshore gateway with Harbour Arch, while Observatory and Milnerton add Table Bay and student-corridor depth below Atlantic Seaboard tickets. Before you pick a project, read the [cost of buying guide](/guides/cost-of-buying-property-cape-town/) for VAT versus duty and the [off-plan Cape Town guide](/guides/off-plan-property-cape-town-guide/) for deposit and NHBRC checks.
