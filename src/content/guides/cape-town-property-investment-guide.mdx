...
faq:
  ...
  - question: "What does it cost to buy property in Cape Town beyond the price?"
    answer: "On a R3 million purchase, budget roughly R160,000 to R200,000 in acquisition costs. Transfer duty on the SARS scale effective 1 April 2025 runs about R100,700, conveyancing and transfer attorney fees add R45,000 to R55,000, and deeds office and FICA charges close the gap. Financing adds bond registration of a similar order to the transfer fee. Nothing in that stack is charged to you for being foreign."
  - question: "How does South African transfer duty work?"
    answer: "It is a sliding scale applied to slices of the price, not a single rate on the whole amount. Nothing is due below R1,210,000; the portion above that is taxed at 3%, then 6%, 8%, 11% and finally 13% on everything above R13,310,000. A R3 million home therefore pays about R100,700, an effective 3.4%, while a R15 million home pays about R1,353,000, an effective 9%. New-build purchases from a VAT-registered developer carry 15% VAT in the price instead of transfer duty."
...
| --- | --- | --- | --- |
| Transfer duty (SARS scale) | R100,700 | Buyer | Nil below R1,210,000 |
...
Worked through three prices, the effective rate climbs steeply and then flattens. A R1.5 million apartment pays R8,700, an effective 0.6%. A R3 million home pays R100,700, an effective 3.4%. A R15 million Atlantic Seaboard house pays about R1,353,000, an effective 9%, because most of its price sits in the 11% band with the top slice at 13%. On prime stock the duty line is the second largest cheque of the transaction, which is why it belongs in the offer arithmetic rather than the closing statement.
