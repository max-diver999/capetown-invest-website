...
readingTime: 14
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/capetown/guides/cape-town-property-investment-guide/photo-1.webp"
heroAlt: "Table Mountain above the Cape Town city centre"
relatedSlugs:
...
Two adjacent markets sit outside this guide and follow different rules. Commercial property is bought on its lease and can transfer with no VAT payable where it sells as a going concern, which the [commercial property guide](/guides/commercial-property-cape-town/) explains. And if you are still choosing a corridor rather than a property, the [suburb map](/guides/cape-town-suburb-map/) places every area in one of nine.
