...
Load-shedding exposure is not automatically a reason to avoid a property, and sometimes it is the reason to buy one well. A home with sound fundamentals and no backup trades at a discount that a well-specified inverter, solar, and battery installation can close, and the spend shows up in both rent and resale. What you cannot fix cheaply is a sectional title block whose body corporate has never funded shared pumps, lifts, and security. The balance below frames the decision.
