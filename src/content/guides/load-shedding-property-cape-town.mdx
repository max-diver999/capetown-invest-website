...
A property with no backup but good fundamentals can be bought at a discount of 8 to 15 percent below comparable backup-ready stock in the same street, then upgraded with solar-plus-battery for R150,000 to R300,000 depending on system size, creating instant value once tenants see reliable supply. City of Cape Town areas get one stage of protection over Eskom zones, so a Stage 3 night means Stage 2 in practice for City-supplied addresses, cutting blackout hours by 30 to 40 percent. Solar recharges batteries by day and cuts monthly electricity bills by R800 to R1,500 on a typical 2-bed unit, so the investment keeps paying back even when load-shedding eases. The downside: sectional title buyers cannot control shared backup and depend on the body corporate to fund a generator or communal system, which often requires a special levy of R15,000 to R50,000 per unit.
...
## Load-shedding due diligence red flags
...
Inverter and battery systems are marketed in kilowatt-hours of storage, but most buyers do not translate that into actual usage hours under load-shedding. A typical 5 kilowatt-hour battery can run lights, Wi-Fi, TV, and a laptop for roughly 4 to 6 hours on a single charge depending on actual load, which covers a Stage 2 or Stage 3 block but empties before back-to-back stages finish. A larger 10 kilowatt-hour system doubles runtime to 8 to 12 hours and lets you add a fridge or small appliances, but it also doubles the capital cost from R80,000 to R150,000 for the battery alone before installation. Solar panels recharge the battery during daylight at roughly 300 to 400 watts per square metre in Cape Town summer sun, so a 4-kilowatt solar array paired with a 10 kilowatt-hour battery can fully recharge in 3 to 5 hours of strong sun and cut your Eskom bill by R1,200 to R1,800 per month on a typical household.

Generator sizing follows different logic because generators are rated by continuous kilowatts of output rather than storage. A 5 kilowatt portable generator can run essential circuits for a small home but will not power a geyser, oven, or air conditioning simultaneously. Estate and body corporate generators step up to 20 kilowatts or 50 kilowatts for shared services including water pumps, lifts, and security, which is why communal generator costs often hit R300,000 to R800,000 for installation plus R15,000 to R40,000 per year in diesel and maintenance depending on usage. Those numbers explain why sectional title schemes raise special levies of R20,000 to R60,000 per unit to fund shared backup, and why a scheme that has already installed a generator is a materially stronger buy than one that is about to hit owners with the bill. Confirm generator runtime hours in the body corporate minutes before you commit.
...
## Buyer scenarios: backup power buyers
