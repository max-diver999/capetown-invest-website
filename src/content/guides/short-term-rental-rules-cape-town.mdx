...
Work top to bottom before you commit capital. A unit can be perfectly zoned and still be unusable for Airbnb because the body corporate banned it; equally, a building can allow short-letting while your insurer quietly excludes it. The plan only works when all four layers say yes. [Foreign owners](/guides/buy-cape-town-property-foreigner/) follow the same rules plus SARS registration and exchange-control records.

<InlineCta text="Found a Cape Town unit you want to short-let? We check body corporate conduct rules and model net yield against long-let fallback before you offer." buttonText="Get STR shortlist" buttonHref="/get-shortlist/" />
...
## Short-term rental compliance red flags
