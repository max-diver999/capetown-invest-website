...
These two suburbs anchor the Cape Town short-term market, and they behave very differently. Sea Point runs on volume, with modeled listings up about 33%, bookings up around 50%, and peak occupancy near 75%. Camps Bay runs on rate, with full-year occupancy near 64% on far higher capital values. The table sets out the modeled contrast.
...
Follow the R4,000,000 example from the top and the compression is visible line by line. Gross STR revenue of R380,000 reads as about 9.5% revenue-to-price, which is the number that appears in listing marketing. Seasonal vacancy and platform fees remove R95,000, leaving R285,000 actually collected. STR management at about 18% takes a further R51,300, and levy, rates, insurance, and maintenance take R57,000, which leaves net operating income of R176,700 and a modeled net yield near 4.4% before finance and income tax. The same unit let on a 12-month lease models about 9.7% gross and 7.5% net, because one tenant costs 8% to 12% in management instead of 18% and carries 5% to 10% vacancy instead of 25% to 40%. That gap is the real question an STR buyer has to answer.

## What are the pros and cons of Airbnb investment in Cape Town?

No letting model is one-sided, and Airbnb in Cape Town trades a higher gross for a thinner, more volatile net. Modeled gross revenue-to-price of 9% to 10% falls to mid-single digits once management at 15% to 20% and seasonal vacancy of 25% to 40% apply. Here is the honest balance for an STR-focused buyer.
