...
Off-plan and resale purchases fail their due diligence in different places. On off-plan you are testing a forecast: the levy stated in the sale agreement, NHBRC enrolment, and how long the developer keeps control of the trustees. On resale you are testing a record: the history of special levies, the current arrears rate, and what the last two AGMs actually resolved.
