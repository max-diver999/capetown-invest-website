...
Exclusive use areas in sectional title are parking bays, storage cages, and balconies allocated to your unit on the sectional plan but often billed separately from the base levy. In MORE Group Foreshore and Century City reviews, a second parking bay added 800 ZAR to 1800 ZAR per month, or 450000 ZAR to 850000 ZAR to effective purchase price when sold apart from the apartment on a 55 sqm unit. Match the sectional plan to the advertised bay before you model net yield on headline price alone.
...
MORE Group foreign-buyer transfers follow the same Cape Town sectional title levies, conduct rules, and voting rights as local owners once registered; non-resident status affects exchange control and tax residency, not body corporate membership. Levy clearance remains mandatory before transfer at the Deeds Office within 8 to 12 weeks typical registration, and offshore purchasers should obtain the full audited pack through a conveyancer within 5 days because power of attorney does not replace due diligence on special levies or short-term rental bans.
...
MORE Group screens Cape Town sectional title packs against four MODELED thresholds before shortlist: levy above 30 percent of achievable rent is red, owner arrears above 15 percent of annual budget is red, special levies above 30000 ZAR in 24 months is red, and reserve funds below 80 percent of the statutory maintenance plan is red. Schemes with three green-band metrics averaged net yields above 4.8 percent in Q2 2026 file review; schemes with two or more red bands averaged under 3.5 percent net on identical rent inputs.
...
Cape Town sectional title DD typically requires 14 days inside a suspensive condition. Request the body corporate pack on day 1, confirm audited financials within 3 days, rebuild net yield with actual levy within 5 days, and verify STR conduct rules within 7 days. Walk away before day 10 if special levies above 30000 ZAR or rental bans invalidate your thesis.
...
Body corporate due diligence differs by buyer goal: income investors prioritize levy-to-rent ratio, STR investors need written letting permission, semigrators need lift age and backup power, off-plan buyers need levy caps, and foreign remote buyers need full packs within 5 days. Match your profile to the decision table before waiving suspensive conditions.
