...
Underwriting rent in Century City means knowing exactly who signs the lease, because the 7.7% MODELED gross yield rests on tenant depth rather than on a scarce address. The on-site office park, Canal Walk and the precinct hotels generate their own tenant pipeline, so demand is created inside Century City rather than imported from the rest of the metro. Five groups dominate the rent roll:
...
## Risks to plan for with Century City Investment 2026
...
## Century City buyer's checklist before you sign
