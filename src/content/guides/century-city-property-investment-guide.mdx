...
description: "Century City apartments: 7.7% modelled gross, Rabie precinct, corporate tenants. Foreign buyers — 50% bond, no surcharge. 2026 guide."
pubDate: 2026-06-17
...
readingTime: 24
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356320/more-group/capetown/guides/century-city-property-investment-guide.jpg"
heroAlt: "Canal Walk and the Century City precinct, Cape Town"
relatedSlugs:
...
For a deeper view of how tenant profile drives returns across the city, read our [Cape Town rental yield guide](/guides/cape-town-rental-yield-guide/).
...
Developer pedigree explains the precinct; it does not set your return. Levies differ enough between blocks to move net yield by a full percentage point inside the mid 5% to low 6% range, so read the body corporate financials of the specific scheme rather than the developer's track record. Our [Rabie Property Developers profile](/developers/rabie-property-developers/) covers the wider portfolio.
...
That contrasts with the UK, with its non-resident stamp-duty surcharge, or Singapore and its additional buyer's stamp duty. Our guide on [buying Cape Town property as a foreigner](/guides/buy-cape-town-property-foreigner/) walks through the eligibility rules in full. Budget four cost lines beyond the price:
...
Century City's risk set is structural rather than locational: body corporate finances, new supply in a master-planned precinct, and the yield-before-growth trade-off. Levy creep alone can move net yield by a full percentage point inside the mid 5% to low 6% range, which is why the scheme review matters more than shaving the purchase price. Address each risk before you commit:
...
A Century City buyer's checklist is short but non-negotiable: the body corporate financials, the levy trend, live rent comparables, and a net yield rebuilt from the 7.7% modelled gross down to the mid 5% to low 6% range. Foreign buyers add the 50% bond ceiling and an offshore funding record.
