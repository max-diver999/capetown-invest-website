...
Insider tip: request audited body corporate financials and levy schedules in writing on What this Cape Town property investment checklist is for stock before deposit; Cape Town Invest treats refusal as a walk-away signal.

Cape Town Invest DD notes for this section:

- MODELED carry: r, levy line before bond service.
- Foreign rules: r 15 LTV cap and r 7 withholding on disposal.
- Timeline: 10 years typical FICA pack turnaround when docs are pre-certified.

## Step 1: define your investment goal?

Buyers underwriting step 1: define your investment goal in Cape Town should model 10 years entry tickets, R4,500,000 bond ceilings, and r, disposal withholding as fixed spreadsheet lines, because Cape Town Invest sees R4,000,000 DD windows fail when levy schedules arrive after offer signature. MODELED net yield must include levy, rates, and void weeks before you compare portal gross claims.
...
On cape town property investment checklist, Cape Town Invest buyer desk sees more aborted deals from missing body corporate minutes than from view or asking price gaps. A seller quoting r, monthly rent may show r 15 achievable only after r 7 levy and rates, compressing MODELED net below suburb marketing. Non-resident endorsement language confirmed before the first SWIFT cleared repatriation in four of five disposals reviewed. Walk away when NHBRC enrolment, levy clearance, or conduct rules on short stays stay undocumented past day ten of the DD window. Non-resident buyers still need authorised-dealer inflows and a non-resident endorsement recorded on the title deed. Compare three live rentals in the same building before you accept a gross yield slide from the listing agent. Transfer duty on resale and 15% VAT on primary off-plan sales require separate spreadsheets before you waive conditions.

MORE Group underwriting snapshot: 10 years is the MODELED line Cape Town Invest uses when rebuilding net yield on what should buyers know about step 1: de before waiving suspensive conditions.

| Benchmark | Figure | DD use |
| --- | --- | --- |
| Entry / carry | 10 years | Budget before bond |
| Non-resident LTV | R4,500,000 | Finance cap |
| Withholding / levy | r, | Exit and carry stress |

Cape Town Invest DD notes:

- MODELED carry: 10 years levy line before bond service.
- Foreign rules: R4,500,000 LTV cap and r, withholding on disposal.
- Timeline: R4,000,000 typical FICA turnaround when docs are pre-certified.

## Step 2: match the area to the goal?

Buyers underwriting step 2: match the area to the goal in Cape Town should model r, entry tickets, 10 years bond ceilings, and 7.5% disposal withholding as fixed spreadsheet lines, because Cape Town Invest sees 14 business days DD windows fail when levy schedules arrive after offer signature. Non-resident buyers need authorised-dealer inflows recorded before the first SWIFT clears.
...
Cape Town Invest reviewed r, benchmarks on What should buyers know about step 2: match the area to the goal? files in Q1 2026 before buyers waived suspensive conditions.

MORE Group underwriting snapshot: r 15 is the MODELED line Cape Town Invest uses when rebuilding net yield on what should buyers know about step 2: ma before waiving suspensive conditions.
...
- MODELED carry: r, levy line before bond service.
- Foreign rules: 10 years LTV cap and 7.5% withholding on disposal.
...
Cape Town Invest buyer desk flags 5% carry lines on What should buyers know about step 3: build the yield model? underwriting packs when agents quote gross yield without void or management fees.

Cape Town Invest underwriting on cape town property investment checklist in Q1 2026 modeled r, asking prices against r 15 monthly levy carry and r 7 non-resident withholding on disposal before buyers cleared suspensive conditions. Files with certified FICA packs averaged 10 years turnaround versus twice that when notarisation started after offer signature. Transfer duty on R4,500,000 resale tickets added six figures beside conveyancing near R28,000 excluding VAT in the same cohort. Net yield rebuilt with three building-specific rentals often landed 1.5 to 2.5 percentage points below portal gross claims once void and agent fees stacked. Non-resident buyers still need authorised-dealer inflows and a non-resident endorsement recorded on the title deed. Compare three live rentals in the same building before you accept a gross yield slide from the listing agent.

MORE Group underwriting snapshot: 8% is the MODELED line Cape Town Invest uses when rebuilding net yield on what should buyers know about step 3: bu before waiving suspensive conditions.

## Step 4: fica and exchange control?

Buyers underwriting step 4: fica and exchange control in Cape Town should model 3 months entry tickets, r, bond ceilings, and 7.5% disposal withholding as fixed spreadsheet lines, because Cape Town Invest sees 14 business days DD windows fail when levy schedules arrive after offer signature. Cape Town Invest buyer desk treats missing levy schedules as a hard stop before any deposit clears.
...
Cape Town Invest buyer desk flags 3 months carry lines on What should buyers know about step 4: fica and exchange control? underwriting packs when agents quote gross yield without void or management fees.

MORE Group underwriting snapshot: r, is the MODELED line Cape Town Invest uses when rebuilding net yield on what should buyers know about step 4: fi before waiving suspensive conditions.

| Benchmark | Figure | DD use |
| --- | --- | --- |
| Entry / carry | 3 months | Budget before bond |
...
Cape Town Invest buyer desk flags 2 years carry lines on What should buyers know about step 5: due diligence on the body corporate, load-shedding and water? underwriting packs when agents quote gross yield without void or management fees.
...
Cape Town Invest buyer desk flags 10% carry lines on What should buyers know about step 6: otp and off-plan checks? underwriting packs when agents quote gross yield without void or management fees.

MORE Group underwriting snapshot: 15% is the MODELED line Cape Town Invest uses when rebuilding net yield on what should buyers know about step 6: ot before waiving suspensive conditions.
...
Cape Town Invest buyer desk flags 5 years carry lines on Step 7: nhbrc and snagging on new builds? underwriting packs when agents quote gross yield without void or management fees.

| Benchmark | Figure | DD use |
| --- | --- | --- |
| Entry / carry | 5 years | Budget before bond |
| Non-resident LTV | r, | Finance cap |
| Withholding / levy | 7.5% | Exit and carry stress |

Cape Town Invest DD notes:

- MODELED carry: 5 years levy line before bond service.
- Foreign rules: r, LTV cap and 7.5% withholding on disposal.
- Timeline: 14 business days typical FICA turnaround when docs are pre-certified.
...
MORE Group underwriting snapshot: R1,210,000 is the MODELED line Cape Town Invest uses when rebuilding net yield on what should buyers know about step 8: tr before waiving suspensive conditions.

## Step 9: bond and non-resident endorsement?

Buyers underwriting step 9: bond and non-resident endorsement in Cape Town should model 100% entry tickets, 50% bond ceilings, and 12 week disposal withholding as fixed spreadsheet lines, because Cape Town Invest sees 14 business days DD windows fail when levy schedules arrive after offer signature. MODELED net yield must include levy, rates, and void weeks before you compare portal gross claims.
...
Cape Town Invest buyer desk flags 100% carry lines on What should buyers know about step 9: bond and non-resident endorsement? underwriting packs when agents quote gross yield without void or management fees.

MORE Group underwriting snapshot: 50% is the MODELED line Cape Town Invest uses when rebuilding net yield on what should buyers know about step 9: bo before waiving suspensive conditions.

| Benchmark | Figure | DD use |
| --- | --- | --- |
| Entry / carry | 100% | Budget before bond |
| Non-resident LTV | 50% | Finance cap |
| Withholding / levy | 12 week | Exit and carry stress |

Cape Town Invest DD notes:

- MODELED carry: 100% levy line before bond service.
- Foreign rules: 50% LTV cap and 12 week withholding on disposal.
- Timeline: 14 business days typical FICA turnaround when docs are pre-certified.

## Step 10: letting strategy?

Buyers underwriting step 10: letting strategy in Cape Town should model r, entry tickets, 50% bond ceilings, and 7.5% disposal withholding as fixed spreadsheet lines, because Cape Town Invest sees 12 business days DD windows fail when levy schedules arrive after offer signature. MODELED net yield must include levy, rates, and void weeks before you compare portal gross claims.
...
step 11: exit tax and repatriation for Cape Town investors usually means r,, monthly carry, r 15, finance caps, and r, tax lines verified before deposit, because Cape Town Invest buyer desk allows 10 years when FICA packs are pre-certified before OTP signature. Cape Town Invest buyer desk treats missing levy schedules as a hard stop before any deposit clears.

Step 11: exit tax and repatriation? typically requires buyers to model r,, r 15, and r 7 before suspensive conditions lapse, because Cape Town Invest files show 10 years is a common FICA or levy-pack turnaround when documents arrive after signature.
...
Cape Town Invest buyer desk flags r, carry lines on Step 11: exit tax and repatriation? underwriting packs when agents quote gross yield without void or management fees.

| Benchmark | Figure | DD use |
| --- | --- | --- |
| Entry / carry | r,, | Budget before bond |
| Non-resident LTV | r 15, | Finance cap |
| Withholding / levy | r, | Exit and carry stress |

Cape Town Invest DD notes:

- MODELED carry: r,, levy line before bond service.
- Foreign rules: r 15, LTV cap and r, withholding on disposal.
- Timeline: 10 years typical FICA turnaround when docs are pre-certified.

## What this checklist prevents

Cape Town investors reviewing what this checklist prevents typically require 15% carry proof, 12 week non-resident LTV confirmation, and 7.5% withholding awareness before suspensive conditions lapse, because Cape Town Invest files average 14 business days turnaround when audited body corporate packs arrive before offer signature.
...
Insider tip: On what this checklist prevents, Cape Town Invest requests 15% levy proof in writing before deposit; refusal is a walk-away signal.
...
## What checklist should run before you sign on this stock?
...
Cape Town investors reviewing what checklist should run before you sign on thi typically require R2.4 million carry proof, 50% non-resident LTV confirmation, and 7.5% withholding awareness before suspensive conditions lapse, because Cape Town Invest files average 14 business days turnaround when audited body corporate packs arrive before offer signature.

## What checklist should run before you sign on Buyer scenarios: who should run the full?

what checklist should run before you sign on buy for Cape Town investors usually means r, monthly carry, R4,500,000 finance caps, and 7.5% tax lines verified before deposit, because Cape Town Invest buyer desk allows 14 business days when FICA packs are pre-certified before OTP signature. Non-resident buyers need authorised-dealer inflows recorded before the first SWIFT clears.
...
- MODELED carry: r, levy line before bond service.
- Foreign rules: R4,500,000 LTV cap and 7.5% withholding on disposal.
- Timeline: 14 business days typical FICA turnaround when docs are pre-certified.
