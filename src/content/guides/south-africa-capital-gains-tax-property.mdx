...
The same R1,033,216 gain produces very different tax depending on who owns the flat, because the inclusion rate and the rate applied to the included portion both move.
