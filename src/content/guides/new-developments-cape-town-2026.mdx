...
For a buyer this cuts two ways. Scarcity supports the value of well-located new stock secured now, particularly on the Atlantic Seaboard and in the City Bowl where infill sites were already limited. It also means the launches that do reach the market face less competition, so developers feel less pressure to discount and launch incentives are thinner than in an oversupplied cycle.
