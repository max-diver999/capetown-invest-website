...
faq:
  ...
  - question: "What developers are building in Cape Town right now?"
    answer: "Well-known Cape Town developers active across the major precincts include Rabie, associated with the Century City master plan and West Coast schemes, Blok, known for design-led apartments on the Atlantic Seaboard, and Prospekt, active with City Bowl and inner-city projects, alongside numerous regional and boutique developers. We do not yet publish dedicated developer pages, so treat these as orientation rather than endorsement, and apply the same developer due diligence to every scheme regardless of the brand name on the hoarding."
---
...
Design-led developers such as Blok have shaped the modern apartment product on this strip, focusing on architecture, light, and finish quality rather than volume. The buyer here is paying for location and scarcity, and the investment case rests on the seaboard's persistent demand from both local and international buyers. Our [Atlantic Seaboard investment guide](/guides/atlantic-seaboard-property-investment-guide/) breaks down the sub-areas and what new stock costs.
...
We do not yet publish dedicated developer pages, so use those names as orientation rather than endorsement, and run the same checklist on every project.
