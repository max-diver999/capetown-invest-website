...
Most Cape Town estates installed rainwater tanks and boreholes during the 2015 to 2018 drought, but tank capacity and borehole yield vary widely. A typical household tank ranges from 2,500 litres to 10,000 litres depending on roof area and storage space. That sounds ample until you run the numbers: a four-person household uses roughly 200 to 400 litres per day under normal consumption, so even a large 10,000-litre tank empties in 25 to 50 days without rain or other supply. Rainwater tanks shine when paired with a borehole or municipal backup because they reduce reliance on either, not replace them outright.

Borehole yield is measured in litres per hour and varies by aquifer. A residential borehole delivering 500 to 1,500 litres per hour can support gardens and pools but struggles with household demand at peak evening hours unless you add storage. Commercial boreholes drilled for estates in the Southern Suburbs during Day Zero averaged 800 litres per hour according to City permit data published in 2019, and many dropped below 600 litres per hour in the dry summer of 2017. That yield spread explains why some estates confidently advertise off-grid water while others ration during dry spells. Ask for the borehole yield test report, not just the driller's anecdote, and confirm the estate stores enough water to bridge a 72-hour pump outage or low-yield day.

Tank and borehole systems also depend on backup power. When load-shedding knocks out the pump, even a full borehole cannot reach your taps or garden, which is why our [load-shedding and property guide](/guides/load-shedding-property-cape-town/) pairs naturally with water resilience due diligence. A property marketed as water-secure but with no inverter for the borehole pump is only conditionally secure, and that conditionality matters during peak summer demand when both load-shedding and water restrictions coincide.

## Buyer scenarios: water-conscious buyers
