...
A borehole, well-point, or rainwater tank gives your property supply independent of municipal restrictions. Boreholes tap groundwater for gardens and pools year-round but need City registration and a pump that runs on electricity. Well-points cost less, work for irrigation, but deliver lower yield in dry months. Rainwater tanks store winter rain for summer use and scale from a single household drum to large estate systems. Most estates combine two or three to cover gardens, pools, and emergency household supply while staying inside City rules. Confirm registration, yield, water quality, and the pump setup during due diligence rather than trusting a listing that simply says borehole.
...
All options require City registration where applicable, groundwater quality checks, and pump backup paired with inverter power because load-shedding can disable boreholes exactly when restrictions tighten. Confirm registration, yield, water quality, and the pump setup during due diligence rather than trusting a borehole label on the listing, and read our [load-shedding and property guide](/guides/load-shedding-property-cape-town/) for the power side of the same equation.

## Who pays for water in a Cape Town sectional title scheme?

In sectional title, water for common property such as gardens, shared pools, and communal supply is paid through the body corporate levy, while water inside your unit is usually metered and billed to you, though some schemes apportion one bulk municipal bill across owners so low users partly subsidise heavy users. Common-area irrigation and pool top-ups can be a meaningful levy line that rises when municipal tariffs rise, while schemes with borehole or tank backup for common areas can keep gardens alive through restrictions and shield owners from the worst outdoor tariff spikes, so confirm metering, billing, backup, and any planned special levy during due diligence.
...
Water security shifts Cape Town net yield by 1.0 to 1.5 percentage points when sectional schemes without borehole backup face levy spikes of 8 to 15 percent after dry summers, while properties with registered boreholes and tanks let faster through restriction periods and support premiums on gardens and pools that justify headline rent. Short-term and holiday lets are most exposed because guests expect normal supply, and rising municipal tariffs eat tenant affordability when billed directly or raise owner holding costs when buried in levies.
...
Water-resilient homes with registered boreholes, well-points, or tanks keep gardens and pools alive through restrictions, support rent and resale premiums, and cut reliance on rising municipal tariffs for outdoor use, but borehole and pump systems carry capital cost, registration rules, electricity dependence during load-shedding, and variable groundwater yield that must be tested rather than assumed from a listing label.
...
Pause when a listing advertises borehole or tank backup without registration proof, yield test data, or pump backup during load-shedding, because unregistered private water can breach City rules and fail exactly when restrictions tighten. Pause when sectional title marketing ignores common-area irrigation costs that sit in levies and can rise 8 to 15 percent after drought years. Pause when a seller refuses water metering and billing documents that show who pays for pools, gardens, and bulk municipal supply.
