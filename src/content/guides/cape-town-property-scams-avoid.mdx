...
Every person who markets property for reward in South Africa must hold a valid Fidelity Fund Certificate issued by the Property Practitioners Regulatory Authority. The certificate is annual, it names the individual and the agency, and it is the mechanism that gives you recourse when funds go astray. An agent without one is trading illegally and cannot lawfully claim commission, which also means the Fidelity Fund cover that sits behind legitimate practitioners is absent on your deal.
...
South Africa runs a public deeds registry, and that registry is your protection. Your conveyancer can pull a deeds search on the specific erf or sectional title unit and read back the registered owner's identity number or company registration, the bond holder and outstanding bond, servitudes, and any interdict or caveat that would block transfer. This search costs very little relative to the purchase price and it is the single check that stands between you and losing the full amount, not just the deposit.
