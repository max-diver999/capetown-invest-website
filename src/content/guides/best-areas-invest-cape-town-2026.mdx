...
The Southern Suburbs suit a buyer who prioritises tenant quality, low vacancy and hold stability over the higher gross yields of the high-density Atlantic Seaboard income suburbs. It is a long-term, family-tenant market, not a short-let tourist market, so model long-let income and a multi-year hold from the outset.
