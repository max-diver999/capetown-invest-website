...
<FaqBlock items={[
  ...
  { question: "Can a foreigner buy property in South Africa in their own name?", answer: "Yes. Buying as a natural person is the simplest and most common route for foreign buyers. You take freehold title in your own name, pay transfer duty on the sliding scale, and a capital gains tax inclusion rate of 40% applies on a future sale. No South African residency or visa is required to own property." },
  { question: "Do you get residency by buying property in South Africa?", answer: "No. Buying property does not grant a visa, permanent residency, or citizenship in South Africa. Ownership and immigration are separate. Residency is obtained through Home Affairs visa categories such as a work visa, business visa, or retired person's visa, each with its own financial and documentary requirements." },
  { question: "Can foreigners get a mortgage or home loan in South Africa?", answer: "Non-residents can usually borrow up to about 50% of the purchase price from a South African bank and must bring the remaining 50% into the country from abroad through formal banking channels. Foreigners who are legally resident and working in South Africa can often access higher loan-to-value ratios, closer to those offered to citizens." },
  { question: "How do exchange control rules affect repatriating sale proceeds?", answer: "If a non-resident introduces the purchase funds through an authorised dealer (a commercial bank) and the transaction is correctly recorded as non-resident, the original capital plus the proportionate gain can be repatriated when the property is sold. Keeping the deal duty correctly stamped and bank-traced is the key step that protects your right to take money out later." },
  { question: "What is FICA and what documents do foreign buyers need?", answer: "FICA is the Financial Intelligence Centre Act, South Africa's anti-money-laundering law. Estate agents, banks, and conveyancing attorneys must verify your identity and source of funds. Foreign buyers typically provide a valid passport, proof of residential address abroad, and evidence of where the purchase money comes from before a transfer can register." }
]} />
