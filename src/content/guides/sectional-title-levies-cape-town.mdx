...
readingTime: 17
heroImage: "https://commons.wikimedia.org/wiki/Special:FilePath/Bo-Kaap_houses_in_Cape_Town.jpg?width=1600"
heroAlt: "A row of brightly painted Bo-Kaap houses, Cape Town"
relatedSlugs:
...
faq:
  ...
  - question: "How do levies affect net rental yield?"
    answer: "Levies come directly off rental income before you calculate net yield. On a R4,000,000 Sea Point apartment modeling 9.7% gross, a R4,000 monthly levy plus R1,803 in rates can remove roughly 1.5 percentage points from net yield before vacancy and management. In Camps Bay, premium levies of R6,000 a month on a R12,000,000 unit are one reason modelled net collapses from 6.8% gross to about 4.4% net."
...
A special levy is a one-off charge raised by the body corporate when the reserve fund cannot cover a major repair, and it is the single largest threat to a Cape Town net yield. Amounts run from about R15,000 per unit for a repaint to R200,000 or more for structural work in a large complex.

Special levies are the reason two apartments with identical rent can deliver very different returns. A body corporate raises one when the reserve fund cannot cover a major repair, and Cape Town's older sectional title stock generates them steadily: roughly R15,000 to R40,000 per unit for a facade repaint, R50,000 to R120,000 for lift replacement, and R80,000 to R200,000 for a full building compliance upgrade. Against a modelled 7.5% net yield, a repaint takes out three to eight months of income and a lift replacement takes out eight to sixteen. The predictive signal sits in the audited financials rather than in the levy invoice: a reserve balance below three months of operating costs in a building over fifteen years old means a special levy is coming, whatever the trustees say at the viewing. Price it into your offer, or move to a scheme whose reserve fund has been funded properly.
...
Levy levels vary more by building than by suburb, but location and stock quality create recognizable bands. A City Bowl walk-up without a lift typically runs R2,000 to R3,000 a month, while a Camps Bay premium complex with pool and full security can run R5,000 to R8,000 or more before municipal rates are added. The table below sets out typical ranges for investor due diligence, not quotes for any specific block.

| Node / building type | Typical monthly levy | Typical monthly rates | Combined holding cost |
| --- | --- | --- | --- |
| City Bowl walk-up, no lift | R2,000 to R3,000 | R605 to R1,022 | R2,605 to R4,022 |
| City Bowl modern block | R3,000 to R4,500 | R744 to R1,301 | R3,744 to R5,801 |
| Sea Point one-bed, mid-range | R2,500 to R4,000 | R736 to R1,115 | R3,236 to R5,115 |
| Sea Point premium with pool | R4,000 to R6,000 | R837 to R1,393 | R4,837 to R7,393 |
| Green Point modern block | R3,500 to R5,000 | R790 to R1,208 | R4,290 to R6,208 |
| Camps Bay premium complex | R5,000 to R8,000+ | R1,301 to R2,692 | R6,301 to R10,692+ |
| Century City sectional title | R2,500 to R4,000 | R466 to R837 | R2,966 to R4,837 |
...
On the Atlantic Seaboard, levy load is one reason Camps Bay models only 4.4% net despite 6.8% gross. Premium complexes with sea views, pools, and full security levy heavily, and those levies come off rent before you calculate net. Sea Point's stronger 7.5% modelled net partly reflects lower levy loads on many mid-range blocks, though premium Sea Point schemes can match Camps Bay on monthly charges.
...
| Less: rates at R736/month | R8,832 |
| Less: insurance and maintenance | R18,000 |
| Net income before management | R287,760 |
| Net yield before management | 7.2% |
| Less: management at 10% | R38,760 |
| Net yield after management | ~6.2% |
...
## What are the pros and cons of sectional title levies for investors?
...
- **Yield-focused investor in Sea Point:** levy level is the difference between 7.5% and 5.2% modelled net on the same rent. Compare three buildings before you choose.
