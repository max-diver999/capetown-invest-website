...
The Financial Intelligence Centre Act is South Africa's anti-money-laundering statute. It does not regulate property directly. It regulates a defined list of accountable institutions, and estate agents, banks, and conveyancing attorneys all sit on that list. Because a residential transfer touches all three, every purchase runs through their compliance obligations.
...
Second, the verification itself is fast. Attorneys clear a complete pack in days. Every delay you will hear about traces back to paperwork that had to travel, not to the check itself. That distinction is what makes preparing early so effective.
...
The documents you assemble for identity and source of funds are the same documents that carry three other parts of the transaction, which is why treating FICA as an isolated hurdle wastes effort.
