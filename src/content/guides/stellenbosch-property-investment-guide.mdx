...
readingTime: 28
heroImage: "https://res.cloudinary.com/dlrrtf6bq/image/upload/v1787356380/more-group/capetown/guides/stellenbosch-property-investment-guide.jpg"
heroAlt: "Stellenbosch University buildings in the winelands town"
relatedSlugs:
...
Underwrite the long lease first, using the method in our [Cape Town rental yield guide](/guides/cape-town-rental-yield-guide/), and treat wine-tourism short-letting as optional upside that estate conduct rules may prohibit outright. Against Sea Point's 9.7% modeled gross, this is a growth and lifestyle allocation.
...
**Look to Cape Town metro** if you need modelled net yield above 6%, short-let scale, or fastest resale liquidity. [Century City](/guides/century-city-property-investment-guide/) and Sea Point serve different income profiles.
...
<FaqBlock items={[
  ...
  { question: "Should I buy an estate or a town apartment in Stellenbosch?", answer: "Estates suit families wanting security and space. Town apartments near the university suit rental demand from academics and professionals with somewhat better modelled yields than estate houses." },
  { question: "How does Stellenbosch compare to Cape Town for investment?", answer: "Cape Town offers higher modelled yields and faster liquidity. Stellenbosch trades lifestyle and space for lower yields. Many investors hold both. See the Cape Town vs Stellenbosch comparison for tables." },
  ...
  { question: "Is short-term rental viable in Stellenbosch?", answer: "Wine tourism helps in peak season, but estates and sectional title schemes often restrict short-letting. Underwrite long-term first at modelled gross near 5% to 6% on town stock." },
